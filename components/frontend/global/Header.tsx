...
function Header() {
  return (
    <header
      className={`top-0 left-0 fixed w-full z-40 md:mb-2 pb-2 backdrop-blur-sm backdrop-filter md:backdrop-filter-none bg-neutral-50/90 dark:bg-neutral-900/90`}
    >
